...
struct Expr {
  ...
  union ExprVariant {
    struct anon_example2_xc_8_2 {
      struct Expr  *lhs;
      struct Expr  *rhs;
      
    } and;
    struct anon_example2_xc_12_2 {
      struct Expr  *lhs;
      struct Expr  *rhs;
        ...
        case (AND):
          ((val) = (((eval)(((({
            ...
            ({
              if ((((e)->tag) != (AND)))
              {
                ((fprintf)((stderr), "example2.xc:26:13:ERROR: mismatched tag\\n"));
                ((exit)(255));
              } else {
                ;
              }
          ...
          ->and).lhs))) && ((eval)(((({
            ...
            ({
              if ((((e)->tag) != (AND)))
              {
                ((fprintf)((stderr), "example2.xc:26:41:ERROR: mismatched tag\\n"));
                ((exit)(255));
              } else {
                ;
              }
        ...
        case (OR):
          ((val) = (((eval)(((({
            ...
            ({
              if ((((e)->tag) != (AND)))
              {
                ((fprintf)((stderr), "example2.xc:30:13:ERROR: mismatched tag\\n"));
                ((exit)(255));
              } else {
                ;
              }
          ...
          ->and).lhs))) || ((eval)(((({
            ...
            ({
              if ((((e)->tag) != (AND)))
              {
                ((fprintf)((stderr), "example2.xc:30:41:ERROR: mismatched tag\\n"));
                ((exit)(255));
              } else {
                ;
              }
        ...
        case (LITERAL):
          ((val) = (({
            ...
            ({
              if ((((e)->tag) != (LITERAL)))
              {
                ((fprintf)((stderr), "example2.xc:34:8:ERROR: mismatched tag\\n"));
                ((exit)(255));
              } else {
                ;
              }
  ...
  ;
  {
    ...
    ((({
      ...
      ({
        ...
        {
          ((fprintf)((stderr), "example2.xc:44:1:ERROR: mismatched tag\\n"));
          ((exit)(255));
        } else {
          ;
        }
    ...
    ((({
      ...
      ({
        ...
        {
          ((fprintf)((stderr), "example2.xc:47:1:ERROR: mismatched tag\\n"));
          ((exit)(255));
        } else {
          ;
        }
    ...
    (((({
      ...
      ({
        if ((((e).tag) != (OR)))
        {
          ((fprintf)((stderr), "example2.xc:51:1:ERROR: mismatched tag\\n"));
          ((exit)(255));
        } else {
          ;
        }
